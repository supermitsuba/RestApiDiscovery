...
func TestWriteFile_OneRecordFile(t *testing.T) {
	...
	WriteRestApiDescriptionsToFile(data, "test/output/TestWriteFile_OneRecordFile.json")
	var result = GetFileOfRestApiDescriptions("test/output/TestWriteFile_OneRecordFile.json")
	if result == nil {
